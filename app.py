...
github_url = 'https://github.com/Pestrunka/TensileData1/'
github_raw_url = 'https://raw.githubusercontent.com/Pestrunka/TensileData1/'
...
def fit_data_on_click_button(n_clicks_fit_data, material, all_constitutive_models, selected_constitutive_model, order, data_type_toggle, fit_mode_toggle, jsonified_selected_exp_data,slider_value):
    ...
    aic_model = ''' '''
    best_model = ''
    url_material = 'https://github.com/Pestrunka/TensileData1'
